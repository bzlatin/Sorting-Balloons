...
/// <summary>
/// Animates an insertion-sort on a row of UI “balloon” objects.
/// Attach to a GameObject, set references, populate <see cref="balloons"/>,
/// then call <see cref="Initialize"/>.
/// </summary>
