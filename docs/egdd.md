...
- Algorithm Simulator:
https://danielzting.github.io/algorithm-simulator/
...
Life System: incorrect moves remove lives (players start with 5).
Efficiency Score: Players receive higher ratings for sorting with optimal steps / quicker.
...
- Drag-and-Swap Sorting / arrow key sorting:
